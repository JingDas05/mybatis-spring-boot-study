...
/**
 * 这个对象是内存缓存的，性能没有问题，这个对应着mapper接口里面的每个方法
 *
        ...
        switch (command.getType()) {
            ...
            case SELECT:
                ...
                if (method.returnsVoid() && method.hasResultHandler()) {
                    ...
                    // 处理返回值为单一对象的方法
                    Object param = method.convertArgsToSqlCommandParam(args);
                    // 对于mybatis-spring-boot-sample-xml的例子
                    // command.getName() = sample.mybatis.mapper.HotelMapper.selectByCityId
                    // param = 1
